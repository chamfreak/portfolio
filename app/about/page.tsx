                    ...
                    <div className="grid md:grid-cols-2 gap-10">
                        <div>
                            <p className="text-gray-400 mb-4">
                                I'm a Front-End Developer who enjoys turning ideas into clean, responsive, and functional digital experiences. I focus on building modern websites and crafting email templates that not only look great but also perform well across all devices and platforms.
                            </p>
                            <p className="text-gray-400 mb-4">
